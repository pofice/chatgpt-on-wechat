...
class Wxbot4Message(ChatMessage):
    ...
    def __init__(self, raw_payload: dict):
        ...
        # 消息内容
        # 对于媒体消息，filepath 存在 extra 中，但文件在远程 Windows 机器上，
        # 这里仅保留文本内容；如果是语音且有转文字结果，用转文字内容
